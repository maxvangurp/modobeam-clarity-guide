...
export const ModobeamLogo = ({
  ...
  <div className={cn("inline-flex min-w-0 items-center gap-3", className)}>
    ...
    <div className="flex min-w-0 flex-col justify-center leading-none">
      <span className="truncate font-display text-[1.08rem] font-semibold tracking-[0.01em] text-foreground">
        Modo<span className="font-light text-foreground/72">beam</span>
      </span>
      {descriptor ? (
        <span className="mt-1 pl-px font-display text-[0.64rem] font-semibold uppercase tracking-[0.12em] text-foreground/54">
          {descriptor}
        </span>
      ) : null}
    </div>
